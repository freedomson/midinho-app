...
import com.lisbongames.app.event.SystemEventReceiver;
import com.lisbongames.app.terminal.TermuxTerminalSessionActivityClient;
import com.lisbongames.app.terminal.TermuxTerminalSessionServiceClient;
import com.lisbongames.shared.termux.plugins.TermuxPluginUtils;
import com.lisbongames.shared.data.IntentUtils;
import com.lisbongames.shared.net.uri.UriUtils;
import com.lisbongames.shared.errors.Errno;
import com.lisbongames.shared.shell.ShellUtils;
import com.lisbongames.shared.shell.command.runner.app.AppShell;
import com.lisbongames.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.lisbongames.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.lisbongames.shared.termux.shell.TermuxShellUtils;
...
import com.lisbongames.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.lisbongames.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.lisbongames.shared.termux.shell.TermuxShellManager;
import com.lisbongames.shared.termux.shell.command.runner.terminal.TermuxSession;
import com.lisbongames.shared.termux.terminal.TermuxTerminalSessionClientBase;
import com.lisbongames.shared.logger.Logger;
import com.lisbongames.shared.notification.NotificationUtils;
...
import com.lisbongames.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.lisbongames.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.lisbongames.shared.R.string.error_execution_cancelled))) {
