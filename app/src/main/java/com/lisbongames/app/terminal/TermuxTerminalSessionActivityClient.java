...
import com.lisbongames.app.TermuxService;
...
import com.lisbongames.shared.termux.terminal.io.BellHandler;
import com.lisbongames.shared.logger.Logger;
import com.lisbongames.terminal.TerminalColors;
import com.lisbongames.terminal.TerminalSession;
import com.lisbongames.terminal.TerminalSessionClient;
import com.lisbongames.terminal.TextStyle;
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {com.lisbongames/com.lisbongames.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
