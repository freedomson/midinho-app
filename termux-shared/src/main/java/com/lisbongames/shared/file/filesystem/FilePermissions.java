...
package com.lisbongames.shared.file.filesystem;
...
public final class FilePermissions {
    ...
    public static Set<FilePermission> fromString(String perms) {
        ...
        if (isR(perms.charAt(0))) result.add(FilePermission.OWNER_READ);
        if (isW(perms.charAt(1))) result.add(FilePermission.OWNER_WRITE);
        if (isX(perms.charAt(2))) result.add(FilePermission.OWNER_EXECUTE);
        if (isR(perms.charAt(3))) result.add(FilePermission.GROUP_READ);
        if (isW(perms.charAt(4))) result.add(FilePermission.GROUP_WRITE);
        if (isX(perms.charAt(5))) result.add(FilePermission.GROUP_EXECUTE);
        if (isR(perms.charAt(6))) result.add(FilePermission.OTHERS_READ);
        if (isW(perms.charAt(7))) result.add(FilePermission.OTHERS_WRITE);
        if (isX(perms.charAt(8))) result.add(FilePermission.OTHERS_EXECUTE);
        return result;
    }
