package com.lisbongames.shared.termux.plugins;
...
import com.lisbongames.shared.android.AndroidUtils;
import com.lisbongames.shared.data.DataUtils;
import com.lisbongames.shared.errors.Errno;
import com.lisbongames.shared.errors.Error;
import com.lisbongames.shared.file.FileUtils;
import com.lisbongames.shared.logger.Logger;
import com.lisbongames.shared.markdown.MarkdownUtils;
import com.lisbongames.shared.models.ReportInfo;
...
import com.lisbongames.shared.termux.file.TermuxFileUtils;
import com.lisbongames.shared.termux.models.UserAction;
import com.lisbongames.shared.termux.notification.TermuxNotificationUtils;
import com.lisbongames.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.lisbongames.shared.R;
import com.lisbongames.shared.shell.command.result.ResultConfig;
import com.lisbongames.shared.shell.command.result.ResultData;
import com.lisbongames.shared.termux.settings.preferences.TermuxPreferenceConstants;
import com.lisbongames.shared.shell.command.result.ResultSender;
import com.lisbongames.shared.termux.settings.preferences.TermuxPreferenceConstants.TERMUX_APP;
...
public class TermuxPluginUtils {
    ...
    public static void setPluginResultPendingIntentVariables(ExecutionCommand executionCommand) {
        ...
        resultConfig.resultStdoutKey = TermuxConstants.TERMUX_APP.TERMUX_SERVICE.EXTRA_PLUGIN_RESULT_BUNDLE_STDOUT;
        ...
        resultConfig.resultStderrKey = TermuxConstants.TERMUX_APP.TERMUX_SERVICE.EXTRA_PLUGIN_RESULT_BUNDLE_STDERR;
        ...
        resultConfig.resultErrCodeKey = TermuxConstants.TERMUX_APP.TERMUX_SERVICE.EXTRA_PLUGIN_RESULT_BUNDLE_ERR;
        resultConfig.resultErrmsgKey = TermuxConstants.TERMUX_APP.TERMUX_SERVICE.EXTRA_PLUGIN_RESULT_BUNDLE_ERRMSG;
    }
