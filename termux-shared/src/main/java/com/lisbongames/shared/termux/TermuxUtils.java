...
import com.lisbongames.shared.reflection.ReflectionUtils;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.lisbongames`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.lisbongames/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.lisbongames" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    /**
     * Get a field value from the {@link TermuxConstants.TERMUX_APP#BUILD_CONFIG_CLASS_NAME} class of the Termux app
    ...
    public static Object getTermuxAppAPKBuildConfigClassField(@NonNull Context currentPackageContext,
        ...
        return getTermuxAppAPKClassField(currentPackageContext, TermuxConstants.TERMUX_APP.BUILD_CONFIG_CLASS_NAME, fieldName);
    }
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.lisbongames.shared.R.raw.apt_info_script);
        try {
