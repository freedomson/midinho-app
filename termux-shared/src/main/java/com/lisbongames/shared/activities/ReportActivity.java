package com.lisbongames.shared.activities;
...
import com.lisbongames.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.lisbongames.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.lisbongames.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
