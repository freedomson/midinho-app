package com.lisbongames.terminal;

/**
 * Native methods for creating and managing pseudoterminal subprocesses. C code is in jni/lisbongames.c.
 */
final class JNI {

    static {
        System.loadLibrary("lisbongames");
    }
